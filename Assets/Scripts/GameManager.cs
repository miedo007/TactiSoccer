...
{
    // public so other managers (e.g. PowerUpManager) can reference it
    ...
    void StartNewTurn()
    {
        ...
        else
        {
            ...
            {
                // grey out two random columns on row ballRow−1
                ...
                for (int i = 0; i < 2; i++)
                {
                    ...
                    cellGO.GetComponent<SpriteRenderer>().color = Color.gray;
                }
